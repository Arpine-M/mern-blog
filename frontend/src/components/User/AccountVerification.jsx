...
const AccountVerifiedComponent = () => {
  ...
  return (
    <div>
        {mutation?.isPending ? <AlertMessage type="loading" message="Verifying your account..." /> : mutation?.isError ? <AlertMessage type="error" message="Something went wrong, try again later. If you think it's a bug, please refresh the page" /> : mutation.isSuccess && 
            <div
